...
- [ ] 1.2 Create LangServe Server File
...
- [ ]* 1.5 Write Property Test for Endpoint Generation
...
- [ ] 2.1 Create Pydantic Input Models
...
- [ ] 2.3 Implement LLM Provider Failover
...
- [ ]* 2.4 Write Unit Test for Provider Failover
  - Mock primary provider failure
  - Verify fallback provider is used
  - Verify response is still returned
  - _Requirements: 11.4_

- [ ] 2.5 Add Error Event Handling for Streaming
...
- [ ]* 2.6 Write Property Test for Error Events
...
- [ ]* 3.1 Write Property Test for Streaming Format
...
- [ ]* 3.3 Write Property Test for Hint Level Progression
...
- [ ]* 3.4 Write Property Test for Multi-Language Code Support
...
- [ ]* 3.5 Write Property Test for Feedback Generation
...
- [ ]* 3.6 Write Property Test for Greeting Variation
...
- [ ] 4.2 Implement Streaming Helper Function
...
- [ ] 4.3 Implement Chatbot API Function
...
- [ ] 4.4 Implement Other Chain API Functions
...
- [ ]* 4.7 Write Property Test for Network Error Handling
...
- [ ]* 5.3 Write Property Test for Message Styling
...
- [ ]* 5.4 Write Property Test for Markdown Rendering
...
- [ ] 5.5 Create ChatbotAssistant Component
...
- [ ] 5.6 Implement Floating Action Button
...
- [ ] 5.8 Implement Message List with ScrollArea
...
- [ ] 5.10 Implement Message Sending Logic
...
- [ ]* 5.11 Write Property Test for Chat History Persistence
...
- [ ]* 5.12 Write Unit Tests for UI Interactions
...
- [ ] 5.14 Apply Ancient Fantasy Asia Theme
...
- [ ]* 6.3 Write Property Test for Context Data Inclusion
...
- [ ] 6.4 Implement Context Update on Navigation
...
- [ ]* 6.5 Write Unit Test for Context Updates
...
- [ ] 9.1 Add Keyboard Accessibility to FAB
  - Ensure FAB is focusable
  - Add visible focus indicator
  - Support Enter/Space to activate
  - _Requirements: 15.1_

- [ ] 9.2 Implement Focus Trap in Sheet
...
- [ ] 10.3 Test Integration in Browser
...
- [ ] 11. Environment Configuration and Documentation
...
- [ ] 11.2 Create Frontend .env.local.example
...
- [ ]* 11.4 Write Unit Test for Environment Validation
  - Test error messages when env vars missing
  - Verify clear instructions are provided
  - _Requirements: 12.3_

- [ ] 11.5 Update README with Setup Instructions
